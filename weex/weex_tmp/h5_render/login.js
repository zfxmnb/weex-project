...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/9175cc2899048ebc04109e385ec1e364', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/9175cc2899048ebc04109e385ec1e364',undefined,undefined)
	  ...
	  "children": [
	    {
	      ...
	      "children": [
	        ...
	        },
	        {
	          ...
	          "style": {
	            "borderColor": function () {return this.userWarn}
	          },
	          "id": "user",
	          "events": {
	            "input": "nameChange"
	        ...
	        },
	        {
	          ...
	          "style": {
	            "borderColor": function () {return this.passWarn}
	          },
	          "id": "pass",
	          "events": {
	    ...
	    ready: function ready() {
	        ...
	        setTimeout(function () {
	            storage.getItem('username', function (e) {
	                if (e.data && e.data != "undefined") me.UserName = e.data;else me.UserName = "";
	            });
	            storage.getItem('password', function (e) {
	                if (e.data && e.data != "undefined") me.PassWord = e.data;else me.UserName = "";
	            });
	        }, 300);
	    },
	    methods: {
